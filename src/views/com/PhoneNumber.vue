<template>
    <div>
          <div style="place-self: 30px; padding-top: 29px; margin-bottom: 25px;">
              <!-- 手机号码  -->
                <div class="ff0" style="font-size: 14px; margin-bottom: 9px;">
                    {{ titleInfoState ? '新手机号码':'手机号码' }}
                    </div>
                <div class="flex ic jc"
                  :style="{ border: blurstate ? '0.5px solid #90FF00' : phoneCheck ? '0.5px solid #E94826' : '0.5px solid rgba(0,0,0,0)' }"
                  style=" width: 100%; cursor: pointer;  position: relative; border-radius: 4px; height: 42px; background: #252525;padding-left: 26px;color: #F0F0F0;">
                  ...
                  <div>
                    <div style="display: flex;">
                      <div class="flex ic jc" style=" height: 26px; border-radius: 4px;" @click="toggleDropdown"> +{{
                        ...
                        " class="triangle" :class="{ rotate: isRotated }"> </div>
                  <!-- 小三角 -->
                      </div>
