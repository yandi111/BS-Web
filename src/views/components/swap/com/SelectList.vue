  ...
  <div style="">
    <div class="flex ic jc" style="
      ...
      <div class="flex ic jb" style="
        ...
        <div style="color: #737373;">{{ chainListTitle }}</div>
      ...
      <transition name="fade">
        ...
        <div v-if="isDropdown" class="dropdowns" style="top: 26px; border-radius: 4px; padding-bottom: 5px;">
          <div style="
                      border-radius: 4px;
                        height: 100%;
                      ...
                      ">
            <div style=" width: 100%;  " class="dropdown-item flex ic jb" 
              @click="selectOptionInfo('IDNULL')">
              <div style="font-size: 12px; display: flex; align-items: center; height: 24px; padding-left: 13px;">
                全部
           </div>
              <div>
            ...
            <div style=" width: 100%;  " class="dropdown-item flex ic jb" v-for="(item, index) in chainList"
              ...
              <div style="font-size: 12px; display: flex; align-items: center; height: 24px; padding-left: 13px;">
                {{ item.contract.coinsName.match(/^([A-Z]+)-/)[1] }} </div>
              <div>
                <span style="font-size: 12px">
                  <!-- +{{ item.code }} -->
                </span>
