<template>
  <div class="card flex">
    <div class="tabs flex">
      <div class="imgList">
        <img v-show="bi === 0" :src="$i18n.locale === 'zh-CN' ? require('../../../assets/images/mobile-zh-b.png') : require('../../../assets/images/mobile-en-b.png')" class="mobile" alt="">
        <img v-show="bi === 1" :src="$i18n.locale === 'zh-CN' ? require('../../../assets/images/pc-zh-b.png') : require('../../../assets/images/pc-en-b.png')" class="pc" alt="">
      </div>
    ...
    <div class="right">
      ...
      <div class="download">
        <div class="qrcode flex">
          <div class="code">
            <img v-if="imageUrl !== ''" :src="imageUrl" class="download_btn" alt="">
            <img v-else src="../../../assets/images/prohibit.png" class="download_btn" alt="">
          </div>
