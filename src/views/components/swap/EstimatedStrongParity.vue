    ...
    <div class="dialog-content" style="border:1px solid #252525;">
     ...
     <div class="con " style="padding-top: 10px;padding-left: 17px; padding-right: 17px;">
      <div
       ...
       <div style="height: 22px; line-height: 22px;">有效杠杆是根据，总账户权益来计算仓位真实杠<br></div>
       <div style="height: 22px; line-height: 22px;">杆倍数，用户可以根据有效杠杆的大小来判断与 <br></div>
       <div style="height: 22px; line-height: 22px;">调整交易策略。<br></div>
      </div>
     </div>
