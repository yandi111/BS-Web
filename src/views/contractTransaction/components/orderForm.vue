  ...
  <div class="order-form">
      ...
      <div class="top">
        ...
        <div class="table">
          <div class="table-header">
            <el-row>
              <el-col :span="8"><div>价格(USDT)</div></el-col>
              <el-col :span="6"
                ><div style="text-align: right">数量(BTC)</div></el-col
              >
              <el-col :span="10"
                ><div style="text-align: right">合计(BTC)</div></el-col
              >
            </el-row>
          </div>
    ...
    <div class="new-price" v-if="tabIndex === 2">
      <div class="new-header">
        <el-row>
          <el-col :span="8"><div>时间</div></el-col>
          <el-col :span="6" style="text-align: right"
            ><div>价格(USDT)</div></el-col
          >
          <el-col :span="10"
            ><div style="text-align: right">数量(BTC)</div></el-col
          >
