      ...
      >
        <template slot-scope="scope">
          ...
          <span v-if="item.typeOwnDefined">
            <span v-if="scope.row.type === 1">{{ scope.row.chainName }}</span>
            <span v-if="scope.row.type === 2">手机</span>
            <span v-if="scope.row.type === 3">邮箱</span>
            <span v-if="scope.row.type === 4">uid</span>
          </span>
          <div v-if="item.coinNameType">
            <span v-if="scope.row.coinName">{{ scope.row.coinName }}</span>
            <span v-else>--</span>
          </div>
          <!-- 备注 -->
          <div v-if="item.remarkType">
