...
<template>
   ...
   <div style="">
              ...
              >
                ...
                >
                  <div class="flex  ic">
                    <!-- <div style="margin-right: 10px; width: 22px; height: 22px;">

                      <img style="width: 100% ; height: 22px;" :src="imagePath" alt="">

                    </div> -->
                   
                    <div> {{ coinAccountTitle }}</div>
                  </div>
                  <div
                  ...
                  <div v-if="isDropdown" class="dropdowns" style="top: 48px; border-radius: 4px;">
                    <div
                      ...
                      <div
                        ...
                        v-for="(item, index) in coinAccountList"
                        @click="selectOptionInfo(item,index)"
                        :key="index"
                      >
                        <div style="font-size: 12px; display: flex; align-items: center; height: 40px; padding-left: 13px;">{{ item.name }}</div>
                        <div>
   ...
   export default {
    ...
    props:{
     ...
     data() {
      ...
      imagePath: require('@/assets/images/deposit-v2/icon_currency.png'),
       }
     },
     watch: {
      coinAccountTitle(newVal) {
    ...
    selectOptionInfo(item,index) {
      ...
      this.$emit('AccountStateFn',item.id)
