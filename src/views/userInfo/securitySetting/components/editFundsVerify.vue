...
<template>
  <div class="user-form">
    <div class="title-context">
      ...
      <span class="title" @click="handleBack">{{ title }}</span>
    </div>
    <div class="form-container">
      <el-form label-position="top" :model="formData" ref="ruleForm">
        <el-form-item
        ...
        >
          ...
          >
            <span
              class="code"
              slot="suffix"
              @click.stop="getPhoneCode(bizTypeCode)"
        ...
        >
          ...
          >
            <span
              class="code"
              slot="suffix"
              @click.stop="getEmailCode(bizTypeCode)"
