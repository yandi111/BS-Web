      ...
      <transition name="fade">
        ...
        <div v-if="isDropdown" class="dropdowns" style="top: 45px; border-radius: 4px; padding-bottom: 5px;">
          <div style="
                      ...
                      ">
            <div style=" width: 100%;  " class="dropdown-item flex ic jb" v-for="(item, index) in chainTypeList"
...
export default {
  ...
  methods: {
    ...
    selectOptionInfo(item) {
      ...
      this.$emit('chainPairListFn',item)
    },
