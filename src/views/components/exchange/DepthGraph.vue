<template>
  <div id="depth_chart">
    <canvas id="depthGraph" style="position:absolute;left:0; background: #141414 !important;">
    </canvas>
    <canvas id="depthGraph_cover" style="position:absolute;left:0;background: #141414 !important;"></canvas>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    draw(plate) {
      ...
      // this.drawAxis();
      this.context.fillStyle = 'pink'
     // this.context.fillRect(0, 0, this.pWidth, this.pHeight); // 绘制背景
      console.log('Background color set to #141414'); // 调试信息
