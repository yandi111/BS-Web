<template>
  <div class="tradingview_form">
    <el-tabs class="tab" v-model="orderName" @tab-click="orderTab">
      <el-tab-pane :label="$t('spot_13')" name="order">
        <ul class="form_tabs">
          <li>{{$t('lang_917')}}+(USDT)</li>
          <li>{{$t('lang_1013')}}+(BTC)</li>
          <li>{{$t('lang_901')}}+(BTC)</li>
        </ul>
      ...
      <el-tab-pane :label="$t('spot_1')" name="record">
        <ul class="form_tabs">
          <li>{{$t('lang_1004')}}</li>
          <li>{{$t('lang_1325')}}+(USDT)</li>
          <li>{{$t('lang_1352')}}+(BTC)</li>
        </ul>
        <div class="form_border"></div>
        <ul class="form_data">
