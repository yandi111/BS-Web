<template>
 <div class="user-form">
  <div class="title-context">
   ...
   <span class="title" @click="onBack">{{ title }}</span>
  </div>
...
export default {
 ...
 methods: {
  ...
  getPhoneCode() {
   ...
   Promise.try(() => {
    return commonSendCaptcha(params)
   }).then(() => {})
  },
  ...
  nextBtn() {
   this.$refs.ruleForm.validate((valid) => {
    if (valid) this.$emit("setAniCodeSubmit")
   });
  },
