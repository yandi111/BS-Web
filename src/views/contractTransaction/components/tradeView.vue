<template>
  <div class="content_right">
    <div class="right_header">
      <el-select v-model="value" placeholder="全仓">
        <el-option
      ...
      <div class="right_lever">杠杆 10X</div>
    </div>
    ...
    <div v-show="priceIndex === 0">
      ...
      <div class="right_container">
        ...
        <div class="buying_btn">
          <div class="buying_left">买入/做多</div>
          <div class="buying_empt"></div>
          <div class="buying_right">卖出/做空</div>
        </div>
        ...
        <!-- 选择框 -->
        <div class="right_select">
          <el-input v-model="timeVal" placeholder="失效时间">
            <div slot="suffix" class="select_item">
    ...
    <div style="width: 428px" v-show="priceIndex === 1">
      <div class="price_content">市价</div>
    </div>
    <div style="width: 428px" v-show="priceIndex === 2">
      <div class="price_content">计划</div>
    </div>
  </div>
</template>
