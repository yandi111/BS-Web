        ...
        <el-carousel indicator-position="outside" arrow="never">
          <el-carousel-item>
            ...
            >
              ...
              />
              <!-- <el-image class="banner-img block" :src="require('@/assets/images/emptyBanner.png')" /> -->
            </div>
          </el-carousel-item>
        </el-carousel>
      </div>
    ...
    <div class="menu pb40">
      <div class="content">
        ...
        <!-- <div class="box pt70">
					...
					<div class="mb40 flexs">
						<div class="line width664">{{ $t(t+'HowToBuyCoinsWithBankCard') }}</div>
						<div class="line">{{ $t(t+'HowToBindOrUnbindBankCard') }}</div>
					</div>
					<div class="mb40 flexs">
						<div class="line width664">{{ $t(t+'TroubleshootBindBankCard') }}</div>
						<div class="line">{{ $t(t+'TroubleshootPaymentFailure') }}</div>
					</div>
					<div class="mb40 line">{{ $t(t+'CommonIssuesWithBankCardPayment') }}</div>
          ...
          <div class="payment_canner">
            ...
            <div class="payment_imgs">
              <div class="img" @click="choosePayment(item.value)" v-for="(item) in payMethods" :key="item.id">
                ...
                <!-- <img class="img_bg" src="@/assets/buy-coins/paymentIcon.png" alt=""> -->
                <div>
                </div>
              </div>
  ...
  methods: {
    ...
    handleType(item, index) {
      ...
      this.$nextTick((_) => {
        ...
        this.$refs.coinsList.formInline.isBulkDeal = 1;
