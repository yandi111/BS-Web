<template>
 <div>
  ...
  <div style="margin-top: 20px; ">
   ...
   <!--  资金密码  -->
   <div style="margin-bottom: 9px; font-size: 14px;color: #F0F0F0;">资金密码</div>
  ...
  <div style="margin-top: 19px;">
   <div style="margin-bottom: 9px; font-size: 14px;color: #F0F0F0;">密码确认</div>
   <div class="input-container" style="margin-bottom: 19px;"
    ...
    <div
     style="cursor: pointer;  display: flex; justify-content: end ;align-items: center ; margin-left: 33px; margin-right: 10px; ">
     <div @click.stop="iconClickNew(1)" v-if="iconOpenNew == 0" style="cursor: pointer; margin-top: 5px;">
      <img src="@/assets/newg/icon_open.png" alt="打开">
     </div>
     <div @click.stop="iconClickNew(0)" v-if="iconOpenNew == 1" style="cursor: pointer; width: 20px; height: 20px;margin-top: -1px;">
      <img style="width: 100%; height: 100%;" src="@/assets/newg/icon_close.png" alt="关闭">
     </div>
    </div>
   </div>
...
export default {
 ...
 methods: {
  ...
  handleInput() {
   ...
   this.$emit('passwordDataClickFunds', this.passwordData)
  },

  handleInputNew() {
   this.$emit('passwordNewDataClickFunds', this.passwordDataNew)
  },
