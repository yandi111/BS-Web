<template>
    <div>
        <!-- 邮箱验证码  -->
        <div>
            <div v-if="stateShow"  class="ff0" style="font-size: 14px; margin-bottom: 9px; ">邮箱号</div>
            <div class="input-containerS" style="height: 42px;">
                ...
                <div class="input-icon " style="cursor: pointer;display: flex;">
                    ...
                    <div style="margin-top: 2px; margin-left:6px;width: 14px; height: 14px;"><img style="width: 100%; height: 100%;" src="@/assets/newg/icon_noticeCCC.png" alt="">
                    </div>
                </div>
            </div>
            <div v-if="stateShow"  style="font-family: PingFang SC;font-size: 14px;font-weight: 500;color: #737373; margin-top: 8px; margin-bottom: 7px; "> 
          获取并输入邮箱{{option.prompt}}收到的验证码，验证码30分钟有效 
        </div>
...
export default {
    ...
    methods: {
        ...
        handleInput() {
            this.$emit('emailCheckCodeClick',this.emailCheckCode)
