<template>
   ...
   <div class="flex" style="margin-top: 15px; margin-bottom: 10px;">
    <div style="font-family: PingFang SC;font-size: 12px;font-weight: 500; color: #737373;">市场价 </div>
   <div style="font-family: PingFang SC;font-size: 13px;font-weight: 600; color: #ED3C2F; margin-left: 5px; ">567.32</div>
   </div>

   <div  class="flex jb" style="border: 1px solid #737373; border-radius: 4px; background: #252525;color: #737373;  font-size: 14px;padding: 8px 10px;" >
    <div>委托价格</div>
    <div style="font-weight: 500; color: #FFFFFF;">765.76</div>
    <div>USDT</div>
   </div>
   <div  class="flex jb" style="margin-top: 10px; border: 1px solid #737373; border-radius: 4px; background: #252525;color: #737373;  font-size: 14px;padding: 8px 10px;" >
    <div>数量</div>
    <div style="font-weight: 500; color: #FFFFFF;margin-left: 24px;">765.76</div>
    <div>USDT</div>
   </div>
          ...
          <div class="con " style="padding-top: 10px;padding-left: 17px; padding-right: 17px;" >
             ...
             <div class="flex ic jb" style="margin-top: 15px;" >
              <div style="font-family: PingFang SC;font-size: 12px;font-weight: 500; color: #737373;" >保证金</div>
              <div style="font-family: PingFang SC;font-size: 13px;font-weight: 600; color: #FFFFFF; " >567.32 USDT</div>
             </div>
             ...
             <div class="flex ic jb" style="margin-top: 8px;" >
              ...
              <div style="font-family: PingFang SC;font-size: 13px;font-weight: 600; color: #FFFFFF; " >0.13 USDT</div>
             </div>
            <button style="padding-left: 158px; padding-right: 158px;"  @click="closeDialog"  class="confirm-button">确定</button> 
          </div>
