...
<template>
     <div>
        <div>
          <div class="flex ic" style=" margin-top: 34px; height: 22px;">
            <div style="font-size: 16px;font-weight: 600; color: #F0F0F0; margin-right: 8px;">
              {{$t('spot_31')}}
            </div>
            <div
        ...
        <div class="flex jb ic" style="height:43px;margin-top: 9px; width: 100%; ">
          <div class="flex ic">
            <div v-if="iconOpen == 1"
              ...
              {{ $formatNumberWithCommas(dataInfo.afterBalance) }}
            </div>
            <div v-else
              style="font-size: 31px;font-weight: 600; color: #F0F0F0; margin-right: 10px;">
              ******
            ...
            <div style="width: 72px ; height: 26px;">
               <SelectListRefund @selectOption="selectOption" :coinPairList="coinPairList" :coinPairTitle ="selectedOption" />
            </div>
        ...
        <div>
          <div v-if="iconOpen == 1" style=" margin-top: 1px;">
            <div style="font-size: 16px;font-weight: 400; height: 22px;color: #B3B3B3;">≈
              {{ $formatNumberWithCommas(dataInfo.afterBalanceCny)  }}
              CNY</div>
        ...
        <!-- <div class="flex jc ic"
          ...
          <div>
      <div v-if="iconOpen == 1" style=" margin-top: 1px;">
        <!-- <div style="font-size: 16px;font-weight: 400; height: 22px;color: #B3B3B3;">≈ {{ totalLegalAsset }}
          CNY</div> -->
        <div class="flex ic" style="margin-top: 25px;">
          <div style="font-size: 14px; color: #737373;">今日收益</div>
          <div style="font-size: 16px; color: #F0F0F0;margin-left: 7px;">{{  $formatNumberWithCommas( dataInfo.profitLossUsdt) }}{{selectedOption}}</div>
          <div style="font-size: 12px; color: #737373;margin-left: 3px;">≈{{$formatNumberWithCommas( dataInfo.profitLoss) }} CNY</div>
          <div class="flex ic jc"
            ...
            {{dataInfo.profitLossRate}}</div>
        </div>
      </div>
      <div v-else style=" margin-top: 1px;">
        <div style="font-size: 16px;font-weight: 400; height: 22px;color: #B3B3B3;">≈ ****** CNY</div>
        <div class="flex ic" style="margin-top: 25px;">
          <div style="font-size: 14px; color: #737373;">今日收益</div>
     ...
     export default {
      ...
      this.$emit('iconOpenChange' , active)
    },
    toggleDropdown() {
    ...
    selectOption(option) {
      ...
      this.$emit('selectedOptionFn',option)
