<template>
    <div >
      ...
      <transition name="fade">
        <div style="" v-if="isDialogVisible" class="dialog-overlay" @click.self="isDialogVisible = false">
          <div class="dialog-content" style="border:1px solid #252525;">
            
            <div class="flex jb" style="width: 300px; padding-top: 17px; padding-bottom: 17px; padding-left: 17px; padding-right: 17px;  border-bottom:1px solid #252525; ">
              <div class="ff flex jc ic" style="font-size: 14px; color: #FFFFFF; " > <span style="width: 21px; height: 21px; display: block; margin-right: 10px;"> <img style="width: 100%; height: 100%;" src="@/assets/images/icon/tx8.png" alt=""></span> 信息提醒</div>
          ...
          <div class="con " style="  padding-top: 10px;padding-left: 17px; padding-right: 17px; padding-bottom: 20px; font-family: PingFang SC;font-size: 15px;font-weight: 500; color: #FFFFFF;" >
            <div>{{ content }}</div>
            <!-- <div> 20，000NEIRO</div>      -->
          </div>   
          </div>
